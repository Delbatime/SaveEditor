...
-------------------------------------------------
 Using partiality:
    Move CustomRegionsSaves.dll into "Rainworld/Mods"
    Apply mods and patches in partiality
 Using Bepinex + BOI:
    Move CustomRegionsSaves.dll into "Rainworld/Mods"
    Enable mod and launch game through BOI
 Using Bepinex ONLY:
    Move CustomRegionsSaves.dll into "Rainworld/bepinex/plugins"
    Run the game
